...
한국인터넷진흥원(KISA)이 발표한 자료에 따르면, 2023년 한 해 동안 국내에서 신고·접수된 IP 카메라 관련 개인정보 침해 신고는 **총 1,243건**으로 전년 대비 18% 증가했다. 이 중 80% 이상이 "취약한 비밀번호 사용" 또는 "펌웨어 미업데이트" 상태의 기기에서 발생했다.
...
- [미국 NDAA 섹션 889 — 통신장비 조달 금지 규정](https://www.congress.gov)
