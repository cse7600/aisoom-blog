...
개인사업자에서 법인으로 전환하거나 새로 법인을 설립한 경영자가 가장 먼저 직면하는 고민은 "법인 돈을 어떻게 개인화할 것인가"이다. 법인의 자금은 대표이사의 개인 자산이 아니므로, 소득세법과 법인세법에 정해진 절차를 따라야 한다. 가장 대중적인 방법은 **급여**와 **배당**이다. 
...
최적의 비율은 매년 법인의 실적과 대표이사의 개인 상황에 따라 달라진다. 일반적으로는 **법인세 비용 처리가 가능한 적정 수준의 급여를 먼저 설정하고, 남는 이익 중 2,000만 원까지를 배당으로 인출**하는 것이 가장 기초적인 절세 공식이다. 하지만 2026년 세법 개정안이 국회 통과 여부에 따라 변동 가능하므로, 최종 결정 전에는 반드시 세무 전문가와 상담해야 한다.
